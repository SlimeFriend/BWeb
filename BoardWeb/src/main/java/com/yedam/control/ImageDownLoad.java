...
public class ImageDownLoad implements Control {
	...
	public void exec(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// [{"imgSrc":"url", "prdName":"상품"},...."....] =>    java객체로 변경하는 작업.
...
//			fileCreate(imgSrc, prdName);  12,600 => 12600
	...
	// 데이터 생성하기.
	String dataCreate(String prodCode, String prdName, String prodPrice) {
		String sql = "insert into tbl_product (prod_code, prod_name, prod_price, prod_image) \n"
		          +  "values('" + prodCode + "', '" + prdName +"', '"+prodPrice + "', '" + prdName +".jpg') \n";
		return sql;
	}
	...
	void fileCreate(String imgSrc, String prdName) {
		...
		try {
			...
			// 출력 스트림
			FileOutputStream fos = new FileOutputStream("c:/temp/img/"+name+".jpg");
